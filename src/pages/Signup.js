...
function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        // Check if passwords match before making request
        ...
        <>
            <div className="signup-container">
                ...
                <form className="signup-form" onSubmit={handleSignup}>
                    ...
                    <input type="password" name="confirmPassword" className="signup-input" placeholder="Confirm Password" onChange={handleChange} required /> {/* New field */}
